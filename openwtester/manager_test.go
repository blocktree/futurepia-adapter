...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "kencani3", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "kencani5", WalletID: walletID, Required: 1, Symbol: "PIA", IsTrust: true}
